# Adapted from 
# https://github.com/googleinterns/IBRNet/blob/master/ibrnet/feature_network.py
...
class ResNet(nn.Module):
    def __init__(self,
        ...
        self.layers = []
        for layer, out_ch in zip(layers, out_chs):
            self.layers.append(
                self._make_layer(block, out_ch, layer, stride=2, dilate=False)
            )
